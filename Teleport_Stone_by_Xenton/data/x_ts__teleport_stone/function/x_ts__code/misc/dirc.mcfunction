...
execute as @e[type=minecraft:interaction,tag=x_ts.interaction.all] on target run function x_ts__teleport_stone:x_ts__code/windows/dialog1 with storage x_ts:teleport_stone data
