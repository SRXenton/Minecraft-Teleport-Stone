...
execute store result storage x_ts:teleport_stone data.temp.success int 1 run function x_ts__teleport_stone:x_ts__code/xm/cv with storage x_ts:teleport_stone data.actions_temp[0]
