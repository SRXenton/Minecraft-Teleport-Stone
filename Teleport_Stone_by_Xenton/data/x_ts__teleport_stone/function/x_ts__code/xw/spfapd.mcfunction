...
## Startpage
execute if score @s x_teleport_stone.admin_pages matches 1 run function x_ts__teleport_stone:x_ts__code/xw/dap1 with storage x_ts:teleport_stone data.temp.dialog
