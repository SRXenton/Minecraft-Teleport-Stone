...
### Called in: xi/fins.mcfunction

## Call function: show teleport coordinates at teleport stone
$execute if entity @e[tag=x_ts.interaction.id.$(id),distance=..10] run function x_ts__teleport_stone:x_ts__code/xm/stcats $(teleport_coords)
