...
execute unless score _counter x_teleport_stone.set_tp_stone matches -1 unless block ~ ~ ~ #air positioned over world_surface run function x_ts__teleport_stone:x_ts__code/raycast/pr
